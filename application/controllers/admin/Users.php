...
class Users extends Admin_Controller {
    ...
    function index() {
        ...
        $this->set_title(lang('users title user_list'));
        $data = $this->includes;
        // set content data
    ...
    function add() {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if ($saved) {
                $this->session->set_flashdata('message', sprintf(lang('users msg add_user_success'), $this->input->post('first_name', TRUE) . " " . $this->input->post('last_name', TRUE)));
            } else {
                $this->session->set_flashdata('error', sprintf(lang('users error add_user_failed'), $this->input->post('first_name', TRUE) . " " . $this->input->post('last_name', TRUE)));
            }
    ...
    function edit($id = NULL) {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if ($saved) {
                $this->session->set_flashdata('message', sprintf(lang('users msg edit_user_success'), $this->input->post('first_name', TRUE) . " " . $this->input->post('last_name', TRUE)));
            } else {
                $this->session->set_flashdata('error', sprintf(lang('users error edit_user_failed'), $this->input->post('first_name', TRUE) . " " . $this->input->post('last_name', TRUE)));
            }
            // return to list and display message
            redirect($this->_redirect_url);
        }
