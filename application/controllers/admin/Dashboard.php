...
class Dashboard extends Admin_Controller {
    ...
    {
        $get_month = $this->Dashboard_model->get_products_year_month(); 
        ...
        $top_products_array = $this->Dashboard_model->get_top_products(date('Y-m-d'));

        $top_products = array();

        foreach ($top_products_array as  $top_products_val) 
        {
            $get_pr_detail =  $this->Dashboard_model->get_product_with_id($top_products_val->product_id);
        ...
        $total_visits = $this->Dashboard_model->get_highest_click($current_month);
        $products_view = $this->Dashboard_model->get_products_view($current_month);
        ...
        $data['market'] = $this->Dashboard_model->markets_count();
        $data['brands'] = $this->Dashboard_model->brands_count();
        $data['category'] = $this->Dashboard_model->categories_count();
        $data['users'] = $this->Dashboard_model->user_count();
    ...
    function get_month_product_view()
    {
        ...
        if($graph_month_time)
        {
                ...
                $total_visits = $this->Dashboard_model->get_highest_click($graph_month);
                $products_view = $this->Dashboard_model->get_products_view($graph_month);
