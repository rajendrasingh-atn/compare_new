...
class MY_Controller extends CI_Controller {
    ...
    function __construct() {
        ...
        //base_url("/{$this->settings->themes_folder}/admin/css/weather-icons.min.css"), base_url("/{$this->settings->themes_folder}/admin/css/weather-icons-wind.min.css"),
        $this->add_external_css(array(base_url("/{$this->settings->themes_folder}/admin/css/bootstrap.min.css"), base_url("/{$this->settings->themes_folder}/admin/css/all.min.css"), 
        // base_url("/{$this->settings->themes_folder}/core/css/core.css")
        ))->add_external_js(array(base_url("/{$this->settings->themes_folder}/admin/js/jquery.min.js"), base_url("/{$this->settings->themes_folder}/default/js/jquery-ui.min.js"), base_url("/{$this->settings->themes_folder}/admin/js/popper.js"), base_url("/{$this->settings->themes_folder}/admin/js/tooltip.js"), base_url("/{$this->settings->themes_folder}/admin/js/bootstrap.min.js"), base_url("/{$this->settings->themes_folder}/admin/js/jquery.nicescroll.min.js"),));
