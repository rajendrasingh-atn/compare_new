...
<script type="text/javascript">
   ...
   console.log(product_visits_array);
</script>
...
<div class="row">
      ...
      <div class="card card-statistic-1">
         ...
         <div class="card-wrap">
            <div class="card-header">
               <h4>
                  <a  href="<?php echo base_url('market/coupon') ?>"><?php echo 'Coupons'; ?> (<?php echo $coupons->count; ?>) </a>
               </h4>
            </div>
         </div>
      </div>
   ...
   <div class="col-lg-3 col-md-6 col-sm-6 col-12">
      <div class="card card-statistic-1">
         ...
         <div class="card-header">
            <h4>
               <a  href="<?php echo base_url('market/product') ?>"><?php echo lang('dashboard Products'); ?> (<?php echo $products->count; ?>) </a>
            </h4>
         </div>
      </div>
   </div>
