...
<div class="row">
   <div class="col-12 col-md-12 col-lg-12">
      <a href ='<?php echo base_url("market/product");?>' class="btn btn-light float-right mb-3"><?php echo lang('core button back'); ?></a>
                        ...
                        <tr  class="market_data">
                           ...
                           <td scope="row">
                              <?php 
                                 ...
                                 elseif(isset($fetch_market_last_data[$marketData['id']]['affiliate_marketing_url']) OR isset($fetch_market_last_data[$marketData['id']]['affiliate_marketing_url']))
                                 {
