...
<div class="row">
   <div class="col-12 col-md-12 col-lg-12">
      <a href ='<?php echo base_url("admin/product");?>' class="btn btn-light float-right mb-3">Back</a>
         ...
         <div class="card-body">
            ...
            <div class="row">
               ...
               <div class="col-12">
                  ...
                  <a href ='<?php echo base_url("admin/product");?>' class="btn btn-dark btn-lg cancelbtn">Cancel</a>
               </div>
            </div>
            <?php echo form_close();?>
         </div>
