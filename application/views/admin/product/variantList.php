...
<div class="panel panel-default">
   ...
   <a href="<?php echo base_url("admin/product");?>" class="btn btn-dark float-right ml-3">Back</a>
   <a href="<?php echo base_url("admin/product/variant_form/".$editData['id']);?>" class="btn btn-primary variantadd float-right" > <?php echo lang('admin Variant btn Add Variant'); ?> </a>
