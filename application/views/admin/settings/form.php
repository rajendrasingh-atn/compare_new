   ...
   <div class="card">
      <div class="card-body">
                     ...
                     <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane<?php echo ($language_key == $this->session->language) ? ' active' : ''; ?>" id="<?php echo $language_key; ?>">
                           ...
                           <?php
                              ...
                              elseif ($setting['input_type'] == 'password')
                              {
         ...
         <div class="row text-right">
            <button type="submit" name="submit" class="btn btn-primary  mr-3"><?php echo lang('core button save'); ?></button>
            <a class="btn btn-dark" href="<?php echo $cancel_url; ?>"><?php echo lang('core button cancel'); ?></a>
         </div>
