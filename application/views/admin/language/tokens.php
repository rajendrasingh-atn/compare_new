                     ...
                     <div class="col-12">
                        <nav>
                          <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active" id="nav-admin-token-tab" data-toggle="tab" href="#nav-admin-token" role="tab" aria-controls="nav-admin-token" aria-selected="true"><?php echo lang('Admin Token'); ?></a>
                            <a class="nav-item nav-link" id="nav-front-token-tab" data-toggle="tab" href="#nav-front-token" role="tab" aria-controls="nav-front-token" aria-selected="false"><?php echo lang('Front Token'); ?></a>
                            <a class="nav-item nav-link" id="nav-other-token-tab" data-toggle="tab" href="#nav-other-token" role="tab" aria-controls="nav-other-token" aria-selected="false"><?php echo lang('Other Token'); ?></a>
                          </div>
                        </nav>
                     </div>
                     ...
                     if($lang_token_array->group_name == 'admin')
                     {
                        ...
                        <div class="col-6">
                           <div class="form-group">
                              <label > <?php echo $lang_token_array->token;?> </label>
                              <?php 
                              ...
                              ?>
                              <input type="text" name="token[<?php echo $lang_token_array->id; ?>]" id="token" class="form-control token" value="<?php echo $populateData;?>">
