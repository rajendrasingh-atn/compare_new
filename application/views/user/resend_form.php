         ...
         <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="card card-primary">
               <div class="card-header">
                  <h4><?php echo lang('Activation Mail'); ?></h4>
               </div>
               <div class="card-body">
                  <p class="text-muted"><?php echo lang('We will send a link to Active your Account'); ?></p>
                  ...
                  <div class="form-group">
                     <button type="submit" name="submit" class="btn btn-block btn-primary btn-lg"><?php echo lang('Resend Activation Mail'); ?></button>
                  </div>
                  <?php echo form_close(); ?>       
               </div>
            </div>
