...
<a href="http://farm9.staticflickr.com/8242/8558295633_f34a55c1c6_b.jpg" title="The Cleaner"><img src="https://cdn3.iconfinder.com/data/icons/block/32/zoom_in_alt-512.png" width="75" height="75"></a>
</div> -->
         ...
         <div class="col-md-4">
            <div class="product-variation">
               <div class="list-product cursor popup-gallery">
                  <?php 
                     $detail_image = json_decode($products->product_image,true);
                     $first_image = isset($detail_image[0]) ? $detail_image[0] : "";
                  ?>
                  <a rel="gallery1" href="<?php echo get_s3_url('quickcompare/products/'.$first_image);?>" title="<?php echo $products->product_title .'_image_1';?> "><img src="<?php echo base_url('assets/images/image-click.jpg');?>" alt="" ></a>
               </div>
               <div class="popup-gallery" style="display: none;">
                  ...
                  ?>
                     <a href="<?php echo $detail_value;?>" title="<?php echo $products->product_title.'_image_'.$i;?>"><img src="<?php echo $detail_value;?>" width="75" height="75"></a>
                  <?php          
                     $i++;}
                  ?>   
               </div>
            ...
            <div class="product-detail-single">
              <?php 
               ...
               <?php @$increase_decrease = ($products->min_price - $products->alarm_price) * 100 / $products->min_price; 

                  $increase_decrease = round($increase_decrease);
                  if($products->alarm_price > $products->min_price)
                  {
               ?>
               ...
               <div class="product-detail-like mt-5">
                  ...
                  <div class="diger">
                     <div class="diger-inner">
                        <a href="javascript:void(0)" data-product_category="<?php echo $products->category_slug ; ?>"  data-product_slug="<?php echo $products->product_slug ; ?>" class="compare_product_link list_compare_link <?php echo $add_to_compare; ?> <?php echo $products->product_slug ; ?>">
        ...
        <div class="row">
            <div class="col-md-12 mb-2">
               ...
               ?>
                  ...
                  <div class="<?php echo $div_row;?> grid-item">
                     ...
                     <span class="table-product-title"><?php echo $products->product_title;?></span>
            ...
            <div class="col-md-12">
              <div class="map-main" id="detail-custome-field">
                 <div class="product-description"><?php echo lang('front Product');?> <?php echo lang('front Details');?> <span><?php echo $products->category_title ." " .$products->product_title . " " .$products->product_description; ?> </span></div>
            ...
            <div class="col-md-12">
                  ...
                  <div class="average-rating-main">
                     <div class="row">
                        ...
                        <div class="col-md-3">
                           <div class="share">
                              <span>Share</span>
                              <span><a href="//www.facebook.com/sharer.php?u=<?php echo base_url('product/').$products->category_slug.'/'.$products->product_slug; ?>"  target="_blank"><i class="fab fa-facebook-f"></i></a></span>
                              <span><a href="//social-plugins.line.me/lineit/share?url=<?php echo base_url('product/').$products->category_slug.'/'.$products->product_slug; ?>&to=<?php echo str_replace(' ', '', get_admin_setting('site_phone_number')); ?>"  target="_blank"><i class="fab fa-line"></i></a></span>
                              <span><a href="//twitter.com/share?text=<?php echo str_replace(' ', '+', $products->product_title); ?>&url=<?php echo base_url('product/').$products->category_slug.'/'.$products->product_slug; ?>" target="_blank"><i class="fab fa-twitter"></i></a></span>
                              <span><a href="tg://msg?text=Checkout: <?php echo str_replace(' ', '+', $products->product_title); ?> on <?php echo base_url('product/').$products->category_slug.'/'.$products->product_slug; ?>&to=<?php echo str_replace(' ', '', get_admin_setting('site_phone_number')); ?>" target="_blank"><i class="fab fa-telegram-plane"></i></a></span>
                              <span><a href="//web.whatsapp.com/send?phone=<?php echo str_replace(' ', '', get_admin_setting('site_phone_number')); ?>&amp;text=Checkout: <?php echo str_replace(' ', '+', $products->product_title); ?> on <?php echo base_url('product/').$products->category_slug.'/'.$products->product_slug; ?>" target="_blank"><i class="fab fa-whatsapp"></i></a></span>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <?php   
                     ...
                     {
                      $count ++;
                      //echo '<pre>';print_r($product_comments);exit;
