(function($)
{
  ...
  var table;
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
          "url": BASE_URL+"market/category/category_list",
          "type": "POST",
        },
    ...
    $('body').on('change','.togle_switch',function(e){
        ...
        $.ajax({
            url: BASE_URL+"market/category/update_status",
            type: "POST",
            data:{category_id:ids,status:status},
            success:function(){
    ...
    $('#custom-fields').multiSelect({ keepOrder: true });
