...
$('#selectcategory').on('change',function(e){
    ...
    $.ajax({
        type: 'POST',
        dataType: 'json',
        url: BASE_URL+'admin/product/get_custom_field_by_category/'+cat_id,
...
$(document).on('click','.edit_product_varient', function(product){
    ...
    $.ajax({
        type: 'POST',
        dataType: 'json',
        url: BASE_URL+'admin/product/product_varient/'+product_id+'/'+product_varient_id,
        data:{
...
$(document).ready(function() {
    ...
    //         $(parent_div).find('.additional_price').removeAttr("disabled");
    ...
    //         $(parent_div).find('.additional_price').attr("disabled","disabled");
