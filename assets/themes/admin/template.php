            ...
            <div class="main-sidebar sidebar-style-2 " tabindex="1" style="overflow: hidden;outline: none;">
               <aside id="sidebar-wrapper">
                  ...
                  <ul class="sidebar-menu">
                     ...
                     <li class="dropdown<?php echo (strstr(uri_string(), 'admin/market')) ? ' active' : ''; ?>">
                        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i class="fas fa fa-globe" aria-hidden="true"></i>
                        <span><?php echo lang('admin button market'); ?></span>
                        </a>
                        <ul class="dropdown-menu">
                           <li class="<?php echo (uri_string() == 'admin/market') ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/market'); ?>" class="nav-link"><?php echo lang('admin button market_list'); ?></a>
                           </li>
                           <li class="<?php echo (uri_string() == 'admin/brand/form') ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/market/form'); ?>" class="nav-link"><?php echo lang('admin button market_add'); ?>
                              </a>
                           </li>
                        </ul>
                     </li>
                     <li class="dropdown<?php echo (strstr(uri_string(), 'admin/brand')) ? ' active' : ''; ?>">
                        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i class="fab fa-blogger-b"></i>
                        <span><?php echo lang('admin button brand'); ?></span>
                        </a>
                        <ul class="dropdown-menu">
                           <li class="<?php echo (uri_string() == 'admin/brand') ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/brand'); ?>" class="nav-link"><?php echo lang('admin button brand_list'); ?></a>
                           </li>
                           <li class="<?php echo (uri_string() == 'admin/brand/form') ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/brand/form'); ?>" class="nav-link"><?php echo lang('admin button brand_add'); ?></a>
                           </li>
                        </ul>
                     </li>
                     <li class="dropdown<?php echo (strstr(uri_string(), 'admin/category')) ? ' active' : ''; ?>">
                        ...
                        <span><?php echo lang('admin button category'); ?></span>
                        </a>
                        <ul class="dropdown-menu">
                           <li class="<?php echo (uri_string() == 'admin/category') ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/category'); ?>" class="nav-link">
                              <?php echo lang('admin button category_list'); ?>
                              </a>
                           </li>
                           <li class="<?php echo (uri_string() == 'admin/category/form') ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/category/form'); ?>" class="nav-link"><?php echo lang('admin button category_add'); ?>
                              </a>
                           </li>
                        </ul>
                     </li>
                     <li class="dropdown <?php echo (strstr(uri_string(),'admin/customfield/customcategorylist')) ? 'active':((strstr(uri_string(), 'admin/customfield/customcategories')) ? 'active' : ''); ?>">
                        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i class="fas fa fa-object-group" aria-hidden="true"></i>
                        <span><?php echo lang('admin button custom group'); ?></span>
                        </a>
                        <ul class="dropdown-menu">
                           <li class="<?php echo (uri_string() == 'admin/customfield/customcategorylist') ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/customfield/customcategorylist'); ?>" class="nav-link"><?php echo lang('admin button catecustom_list'); ?>
                              </a>
                           </li>
                           <li class="<?php echo (uri_string() == 'admin/customfield/customcategories') ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/customfield/customcategories'); ?>" class="nav-link"><?php echo lang('admin button catecustomfield_add'); ?>
                              </a>
                           </li>
                        </ul>
                     </li>
                     <li class="dropdown <?php echo uri_string()=='admin/customfield' ? ' active' : ((strstr(uri_string(), 'admin/customfield/form')) ? 'active' : ''); ?>">
                        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i class="fas fa-anchor"></i>
                        <span><?php echo lang('admin button custom'); ?></span>
                        </a>
                        <ul class="dropdown-menu">
                           <li class="<?php echo (uri_string() == 'admin/customfield') ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/customfield'); ?>" class="nav-link"><?php echo lang('admin button custom_list'); ?>
                              </a>
                           </li>
                           <li class="<?php echo (uri_string() == 'admin/customfield/form') ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/customfield/form'); ?>" class="nav-link"><?php echo lang('admin button customfield_add'); ?>
                              </a>
                           </li>
                        </ul>
                     </li>
                     <li class="dropdown<?php echo (strstr(uri_string(), 'admin/product')) ? ' active' : ''; ?>">
                        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i class="fas fa-mobile-alt"></i>
                        <span><?php echo lang('admin button product'); ?></span>
                        </a>
                        <ul class="dropdown-menu">
                           <li class="<?php echo (uri_string() == 'admin/product') ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/product'); ?>" class="nav-link"><?php echo lang('admin button product_list'); ?>
                              </a>
                           </li>
                           <li class="<?php echo (uri_string() == 'admin/product/form') ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/product/form'); ?>" class="nav-link"><?php echo lang('admin button product_add'); ?>
                              </a>
                           </li>
                        </ul>
                     </li>
                     <li class="dropdown<?php echo (strstr(uri_string(), 'admin/rating')) ? ' active' : ''; ?>">
                        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                           <i class="fa fa-star" aria-hidden="true"></i>
                           <span><?php echo 'Rating'; ?></span>
                        </a>
                        <ul class="dropdown-menu">
                           <li class="<?php echo (uri_string() == 'admin/rating') ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/rating'); ?>" class="nav-link"><?php echo 'Disapprove Rating List';?></a>
                           </li>
                           <li class="<?php echo (uri_string() == 'admin/rating/approve') ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/rating/approve'); ?>" class="nav-link"><?php echo 'Approve Rating List';?></a>
                           </li>   
                        </ul>
                     </li>
                     ...
                     <li class="dropdown<?php echo (strstr(uri_string(), 'admin/language')) ? ' active' : ''; ?>">
                        ...
                        <span><?php echo lang('admin button language'); ?></span>
                        </a>
                        <ul class="dropdown-menu">
                           <li class="<?php echo (uri_string() == 'admin/language') ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/language'); ?>" class="nav-link"><?php echo lang('admin button language_list'); ?>
                              </a>
                           </li>
                           <li class="<?php echo (uri_string() == 'admin/language/add') ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/language/add'); ?>" class="nav-link"><?php echo lang('admin button language_add_new'); ?>
                              </a>
                           </li>

                           <?php /**
                          <!--  <li class="<?php echo (uri_string() == 'admin/language/reganrate') ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/language/reganrate'); ?>" class="nav-link"><?php echo 'Regnarate File'; ?>
                              </a>
                           </li> -->
                           */?>
                     ...
                     <li class="dropdown<?php echo (strstr(uri_string(), 'admin/coupon')) ? ' active' : ''; ?>">
                        ...
                        <ul class="dropdown-menu">
                           <li class="<?php echo (uri_string() == 'admin/coupon') ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/coupon'); ?>" class="nav-link"><?php echo 'Coupon List'; ?>
                              </a>
                           </li>
                           <li class="<?php echo (uri_string() == 'admin/coupon/add') ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/coupon/add'); ?>" class="nav-link"><?php echo 'Coupon Add'; ?>
                              </a>
                           </li>
                        </ul>
                     </li>

                     <li class="<?php echo (uri_string() == 'admin/Excel_import') ? 'active' : ''; ?>">
                        <a href="<?php echo base_url('/admin/Excel_import'); ?>" class="nav-link">
                     ...
                     <li class="<?php echo (uri_string() == 'admin/contact') ? 'active' : ''; ?>">
                        ...
                        <span><?php echo lang('admin button messages'); ?></span>
                        </a>
                     </li>
                     ...
                     <li class="dropdown <?php echo (strstr(uri_string(), 'admin/users')) ? ' active' : ''; ?>">
                        ...
                        <ul class="dropdown-menu">
                           <li class="<?php echo (uri_string() == 'admin/users') ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('/admin/users'); ?>" class="nav-link"><?php echo lang('admin button users_list'); ?>
                              </a>
                           </li>
